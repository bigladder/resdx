...
class PsychState:
    ...
    def set_rh(self, rh):
        ...
        if not self.wb_set:
            self.set_wb(
                fr_u(psychrolib.GetTWetBulbFromRelHum(self.db_C, self.rh, self.p), "°C")
            )
        self.rh_set = True
        return self.rh
    ...
    def set_hr(self, hr):
        ...
        if not self.wb_set:
            self.set_wb(
                fr_u(
                    psychrolib.GetTWetBulbFromHumRatio(self.db_C, self.hr, self.p), "°C"
                )
            )
        self.hr_set = True
        return self.hr
    ...
    def set_h(self, h):
        ...
        if not self.hr_set:
            self.set_hr(
                psychrolib.GetHumRatioFromEnthalpyAndTDryBulb(self.h, self.db_C)
            )
        self.h_set = True
        return self.h
    ...
    def get_rho(self):
        if self.rho_set:
            ...
            return self.set_rho(
                psychrolib.GetMoistAirDensity(self.db_C, self.get_hr(), self.p)
            )
    ...
    def get_hr(self):
        if self.hr_set:
            ...
            return self.set_hr(
                psychrolib.GetHumRatioFromTWetBulb(self.db_C, self.get_wb_C(), self.p)
            )
