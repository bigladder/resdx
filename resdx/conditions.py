...
class OperatingConditions:
  ...
  def set_rated_airflow(self, rated_volumetric_airflow, rated_net_total_cooling_capacity):
  ...
  def set_airflow(self, volumetric_airflow):
    ...
    if self.rated_airflow_set:
      ...
      self.standard_volumetric_airflow_per_capacity = self.standard_volumetric_airflow/self.rated_net_total_cooling_capacity
