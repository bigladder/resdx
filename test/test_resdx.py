...
def test_1_speed_regression():
    """Test single speed, SEER 13, HSPF 8."""
    seer_1 = 13.0
    hspf_1 = 8.0
    cop_1_c, _ = optimize.newton(
...
def test_2_speed_regression():
    """Test two speed, SEER 17, HSPF 10."""
    seer_2 = 17.0
    hspf_2 = 10.0
...
def test_vchp_regression():
    """Test SEER 21.3, EER 13.4, HSPF(4) = 11.7."""
...
def test_plot():
    ...
    ax1.plot(temperature_out, heating_capacity_integrated, color=color)
    ax1.plot(temperature_out, heating_power_integrated, color=color)
    ...
    ax2.plot(temperature_out, cop_integrated, color=color)
