...
Q_nrel = [test_dx_system.gross_integrated_heating_capacity(condition) for condition in conditions]
#
Qhenderson = [test_dx_system_henderson.gross_integrated_heating_capacity(condition) for condition in conditions]
#
