...
seer2 = 14.3
hspf2 = 7.5
cop_c, solution_c = optimize.newton(lambda x : resdx.DXUnit(number_of_input_stages=2, rated_gross_cooling_cop=x, input_seer=seer2, rating_standard=resdx.AHRIVersion.AHRI_210_240_2023).seer() - seer2, seer2/3.33, full_output = True)
